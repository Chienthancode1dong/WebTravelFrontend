...
const Footer = () => {
  return (
    <div className='bg-[var(--color-2)] text-gray-500/80 pt-8 px-6 md:px-16 lg:px-24 xl:px-32 z-0'>
            <div className='flex flex-wrap justify-between gap-12 md:gap-6'>
                <div className='max-w-80'>
                    ...
                    <div className='flex items-center gap-3 mt-4'>
                        {/* Instagram */}
                        <Image src={assets.instagramIcon} alt="instagram-icon" width={24} height={24} className='w-6' />
                        {/* Facebook */}
                        <Image src={assets.facebookIcon} alt="facebook-icon" width={24} height={24} className='w-6' />
                        {/* Twitter */}
                        <Image src={assets.twitterIcon} alt="twitter-icon" width={24} height={24} className='w-6' />
                        {/* Linkendin */}
                        <Image src={assets.linkendinIcon} alt="linkendin-icon" width={24} height={24} className='w-6' />
                    </div>
                </div>
