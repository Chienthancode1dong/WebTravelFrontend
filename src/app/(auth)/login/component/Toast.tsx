...
const Toast = ({ id, type, title, message, duration = 5000, onClose }: ToastProps) => {
  ...
  return (
    <div className={`max-w-sm w-full border rounded-lg shadow-lg p-4 mb-4 ${getToastStyles()}`}>
      ...
      <div className="mt-2">
        <div className="bg-black bg-opacity-10 rounded-full h-1">
          <div
            className={`h-1 rounded-full transition-all ease-linear ${type === 'success' ? 'bg-green-600' :
