...
const Destinations = () => {
  ...
  return (
    <div className="w-full h-[706px] bg-white text-black  ">
        <div className="mt-[160px] w-full h-[165px] grid 2xl:grid-cols-[120px_1fr_120px]  xl:grid-cols-[60px_1fr_60px]  grid-cols-[50px_1fr_120px]">
          ...
          <div className="w-full h-[641px]   grid 2xl:grid-cols-[120px_1fr_120px]  xl:grid-cols-[60px_1fr_60px]  grid-cols-[50px_1fr_120px]">
