    ...
    <div>
      ...
      <div className='flex gap-4 my-8'>
        ...
        <div className='bg-[var(--color-2)]/50 border border-[var(--color-1)]/40 rounded-3xl flex p-4 pr-8'>
          <Image src={assets.totalBookingIcon} alt="" className='max-sm:hidden h-10 invert' width={40} height={40} />
        ...
        {/*tổng doanh thu */}
        <div className='bg-[var(--color-2)]/50 border border-[var(--color-1)]/40 rounded-3xl flex p-4 pr-8'>
          <Image src={assets.totalRevenueIcon} alt="" className='max-sm:hidden h-10 invert' width={40} height={40} />
          <div className='flex flex-col sm:ml-4 font-medium'>
