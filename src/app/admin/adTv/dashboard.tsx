    ...
    <div>
      ...
      <div className='flex gap-4 my-8'>
        ...
        <div className='bg-[var(--color-heavy)] border border-[var(--color-secondary)] rouded flex p-4 pr-8'>
          <Image src={assets.booking_icon} alt="" className='max-sm:hidden h-10' width={40} height={40} />
        ...
        {/*tổng doanh thu */}
        <div className='bg-[var(--color-heavy)] border border-[var(--color-secondary)] rouded flex p-4 pr-8'>
          <Image src={assets.revenue_icon} alt="" className='max-sm:hidden h-10' width={40} height={40} />
          <div className='flex flex-col sm:ml-4 font-medium'>
